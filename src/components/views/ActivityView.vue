<template>
  <div class="cnw-social-worker-activity-view">
    ...
    <div class="cnw-social-worker-placeholder-card">
      ...
      <p>Track your questions and replies coming soon!</p>
    </div>
  </div>
</template>

<script>
export default { name: 'ActivityView' };
</script>

<style>
.cnw-social-worker-activity-view { display: flex; flex-direction: column; gap: 16px; }

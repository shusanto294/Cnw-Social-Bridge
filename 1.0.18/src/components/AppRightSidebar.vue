<template>
  <aside class="cnw-social-worker-right-sidebar" aria-label="Supplementary content">
    <!-- Following Tags -->
    <div v-if="isLoggedIn" class="rsidebar-card">
      <div class="rsidebar-card-header">
        <h3>Following Tags</h3>
        <button class="edit-tags-btn" @click="$router.push('/tags')" aria-label="Edit followed tags">
    ...
    <div class="rsidebar-card">
      ...
      <div class="hot-questions-list">
        <div
          ...
          role="link"
          tabindex="0"
          @keydown.enter="$router.push('/thread/' + q.id)"
          :aria-label="'Read question: ' + q.title"
        >
          ...
          <div class="hq-stats-row">
            <span class="hq-stat-group">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="var(--red)" stroke="none" aria-hidden="true"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
          ...
          <div class="hq-meta-row">
            <svg width="14" height="14" viewBox="0 0 14 14" aria-hidden="true"><circle cx="7" cy="7" r="7" fill="#F5A623"/></svg>

...
export default {
  ...
  methods: {
    ...
    async openConversation(conv) {
      ...
      this.isConnected = 'can_message' in conv ? !!conv.can_message : !!conv.is_connected;
    ...
    async loadMessages() {
      ...
      try {
        ...
        if ('can_message' in data) this.isConnected = !!data.can_message;
        else if ('is_connected' in data) this.isConnected = !!data.is_connected;
        if ('blocked_by' in data) this.blockedBy = data.blocked_by || null;
        if (data.other_user) {

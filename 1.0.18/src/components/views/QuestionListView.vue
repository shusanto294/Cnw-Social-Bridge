    ...
    <div class="list-topbar">
      ...
      <div class="filter-tabs">
        ...
        <div class="layout-dropdown-wrap">
          <button class="filter-dots-btn" @click.stop="layoutOpen = !layoutOpen" aria-label="Layout options" aria-haspopup="listbox" :aria-expanded="layoutOpen">
          ...
          <div v-if="layoutOpen" class="layout-dropdown" role="listbox">
            <button
              class="more-dropdown-item"
              :class="{ 'is-active': layoutMode === 'card' }"
              @click="setLayout('card')"
              role="option"
              :aria-selected="layoutMode === 'card'"
            >Card</button>
            <button
              class="more-dropdown-item"
              ...
              role="option"
              :aria-selected="layoutMode === 'compact'"
            >Compact</button>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      moreOpen: false,
      layoutOpen: false,
      layoutMode: localStorage.getItem('cnw_layout_mode') || 'card',
      activeFilter: 'newest',
      searchQuery: '',
      threads: [],
      loading: true,
  ...
  mounted() {
    this.fetchThreads();
    this._closeMore = () => { this.moreOpen = false; this.layoutOpen = false; };
  ...
  methods: {
    setLayout(mode) {
      ...
      localStorage.setItem('cnw_layout_mode', mode);
